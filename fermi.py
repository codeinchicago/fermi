...
NUM_EQUIV_VOLUMES = 1000 #Number of locations for civilizations
MAX_CIVS = 5000 #Max number of advanced civilizations
TRIALS = 1000 #Number of times to model given number of civilizations
...
#Polynomial regression on detection/civs per volume
